...
<div id="starcraft2lotv">
        ...
        <div class="panel-group">
            <div class="panel">
                <div class="panel-heading text-center">
                    <img src="/img/sc2/main.png" alt="main.png" class="img-rounded img-responsive" />
                    <hr>
                </div><!--panel-heading-->
            ...
            <div class="panel">
                <div class="panel-heading">
                     <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation">
                            <a href="#sign" aria-controls="sign" role="tab" data-toggle="tab">Register</a>
                        </li>
                        <li role="presentation">
                    ...
                    <div class="tab-content">
                            ...
                            <div class="panel-group">
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <p>MPC is divided a mixture of perfectionists, coaches, and loyalist for gaming. We wish to put you in touch with proper MPC members that might aid the goals you're working for in Starcraft 2. Use the Discord, or the In Game Clan Link to find an Officer to help you. If not sure who to speak to, then ask a member to help you. To Join MPC, you can use Discord to reach us.</p>
                                        <a href="#discord" aria-controls="discord" role="tab" data-toggle="tab">Speak to an Officer</a>
                                    </div><!--panel-body-->
                                </div><!--panel-->
                            </div><!--panel-group-->
                        </div><!--tab-panel(join)-->
                        ...
                        <div role="tabpanel" class="tab-pane fade in" id="schedule">
                            <div class="panel-group">
                                ...
                                <div class="panel-heading">
                                    <h3 class="panel-title">
                                        Schedule a Clan War Against MPC
                                    </h3>
                                </div>
                                <div class="panel-body">
                                    <div class="row">
                        ...
                        <div role="tabpanel" class="tab-pane fade in" id="guide">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel-group">
                <div class="panel" id="test" style="background-color: transparent;">
