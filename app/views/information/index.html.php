...
//the numeric value inbetween $info and Indexes is the corresponding Row. Each row has 3 .Well Class Divs.
$info1Indexes = array
    (
        'aboutus',
        'communication',
...
<div id="mpc-information">
    <div class="panel-group" id="accordion2" role="tablist" aria-multiselectable="false">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="well" role="button" data-toggle="collapse" data-parent="#accordion2" href="#info-<?= $infoIndex ?>-collapse" aria-expanded="false" aria-controls="info-<?= $infoIndex ?>-collapse">
        ...
        <div class="row">
            ...
            <div id="info-<?= $infoIndex ?>-collapse" class="panel-collapse collapse" role="tabpanel" aria-labelledby="">
                <div class="well">
                    <?= $this->view()->render(
